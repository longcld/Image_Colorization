...
if __name__ == '__main__':
    ...
    model_weights_path = 'models/model.00-10.1351.hdf5'
    model = build_model()
    model.load_weights(model_weights_path)

    print(model.summary())

    image_folder = '../Image/resized'
    ...
    for i in range(len(samples)):
        ...
        cv.imwrite(save_folder + '/{}_image.png'.format(i), gray)
        cv.imwrite(save_folder + '/{}_gt.png'.format(i), bgr)
        cv.imwrite(save_folder + '/{}_out.png'.format(i), out_bgr)
